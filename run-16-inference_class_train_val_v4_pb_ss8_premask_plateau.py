...
from models_train.ms_resnet_more import Network as Network2
...
run = wandb.init(
    name = "premask-cmod-lron-reg", ## Wandb creates random run names if you skip this field
